...
engine_creation = 'mysql+pymysql://root:wushuang123@localhost:3306/ltedb'
table_Name = [
...
sql_create = [
    """ 
        ...
        (   
            ...
            第99个PRB上检测到的干扰噪声的平均值       INT NULL,            
            PRIMARY KEY(起始时间,网元或基站名称,小区描述,小区名称) 
            -- FOREIGN KEY(起始时间,网元或基站名称,小区描述,小区名称) REFERENCES tbprb(起始时间,网元或基站名称,小区描述,小区名称)
        );      
        """, """
        (
        ...
        (
            ...
            -- FOREIGN KEY(SectorA) REFERENCES tbcell(SECTOR_ID),
            -- FOREIGN KEY(SectorB) REFERENCES tbcell(SECTOR_ID),
            -- FOREIGN KEY(SectorC) REFERENCES tbcell(SECTOR_ID)
        ); 
        """
]
sql_trigger = [
